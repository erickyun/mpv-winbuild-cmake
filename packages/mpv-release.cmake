...
"#!/bin/bash
tag=$(curl -sI https://github.com/erickyun/mpv/releases/latest | grep 'location: https://github.com/erickyun/mpv/releases' | sed 's#.*/##g' | tr -d '\r')
printf 'https://github.com/erickyun/mpv/archive/%s.tar.gz' $tag")
